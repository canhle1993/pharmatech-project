...
@Component({
  selector: 'app-purchase-customer-intake',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, EditorModule, ButtonModule, ToastModule],
  providers: [MessageService],
  templateUrl: './purchase-customer-intake.component.html',
  styleUrls: ['./purchase-customer-intake.component.css']
})
export class PurchaseCustomerIntakeComponent implements OnInit {
  form!: FormGroup;
  selectedImage: File | null = null;
  imagePreview: string = '';
  isUploading = false;
  imageBase = env.imageUrl;
  pageName = 'customer-intake';
