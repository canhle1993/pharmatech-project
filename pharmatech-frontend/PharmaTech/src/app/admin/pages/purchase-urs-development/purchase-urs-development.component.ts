...
@Component({
  selector: 'app-purchase-urs-development',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, EditorModule, ButtonModule, ToastModule],
  providers: [MessageService],
  templateUrl: './purchase-urs-development.component.html',
  styleUrls: ['./purchase-urs-development.component.css']
})
export class PurchaseUrsDevelopmentComponent implements OnInit {
  form!: FormGroup;
  selectedImage: File | null = null;
  imagePreview: string = '';
  isUploading = false;
  imageBase = env.imageUrl;
  pageName = 'urs-development';
