...
@Component({
  selector: 'app-purchase-contract-signing',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, EditorModule, ButtonModule, ToastModule],
  providers: [MessageService],
  templateUrl: './purchase-contract-signing.component.html',
  styleUrls: ['./purchase-contract-signing.component.css']
})
export class PurchaseContractSigningComponent implements OnInit {
  form!: FormGroup;
