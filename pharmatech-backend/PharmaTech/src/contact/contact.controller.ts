...
export class ContactController {
  ...
  async createContact(
    ...
    try {
      ...
      if (body.addresses) {
        dto.addresses = typeof body.addresses === 'string' 
          ? JSON.parse(body.addresses) 
          : body.addresses;
      }
      if (body.phones) {
        dto.phones = typeof body.phones === 'string' 
          ? JSON.parse(body.phones) 
          : body.phones;
      }
      if (body.emails) {
        dto.emails = typeof body.emails === 'string' 
      ...
      throw new BadRequestException(error.message || 'Failed to create contact');
    }
  }
